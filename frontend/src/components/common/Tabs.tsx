...
const tabVariantClasses = {
  ...
  buttons: {
    base: 'px-4 py-2 text-sm font-medium rounded-md transition-colors border border-gray-300',
    active: 'bg-indigo-600 text-white border-indigo-600',
    inactive: 'text-gray-700 hover:bg-gray-50',
    disabled: 'text-gray-300 cursor-not-allowed border-gray-200'
  }
};
...
// TabPanel for when you want to control content separately
